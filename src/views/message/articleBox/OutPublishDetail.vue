  ...
  <div class="container">
    <div class="breadcrumb-box">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item :to="{ name: 'PublishDetail' }">外部投稿情况</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div>
      ...
      <el-table border
        ...
        <!-- <el-table-column prop="publishChannel"
          ...
          <template slot-scope="scope">
            <div v-if="scope.row.publishChannel === 'platform'">
              平台
            </div>
            <div v-else-if="scope.row.publishChannel === 'weixin'">
              微信
            </div>
            <div v-else-if="scope.row.publishChannel === 'weibo'">
              微博
            </div>
            <div v-else-if="scope.row.publishChannel === 'toutiao'">
              头条
            </div>
            <div v-else-if="scope.row.publishChannel === 'website'">
              网站
            </div>
          </template>
        </el-table-column> -->
...
export default {
  ...
  methods: {
    ...
    // 获取发布情况
    getExamine () {
      this.fromData.articleId = parseInt(this.$route.query.id)
      this.$http.post(this.$api.sendList, this.fromData)
        .then(res => {
