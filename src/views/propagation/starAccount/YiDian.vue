      ...
      <div class="account-list">
        <div class="list-box"
          ...
          <el-image :src="require('@/assets/images/empty-data.png')"
                    :fit="'fill'"></el-image>
          <p><router-link class="text-click" :to="{name:'UserList',query:{dis:this.form.cid,tabs:'yidian'}}">暂无数据,请前往添加</router-link></p>
        </div>
        <div class="account-list-box"
          ...
          <el-badge :value="item.unreadCount"
            ...
            <div class="account-img"
              ...
              <div class="head-img"
                   :style="{ 'backgroundImage': 'url(' + item.channel_cover + ')' }">
              </div>
            </div>
          </el-badge>
...
export default {
  ...
  methods: {
    ...
    routeBank (item, index) {
      this.$router.push({ name: 'AccountDetail', query: { id: item.id, type: 'yidian' } })
    },
    // 获取文件夹
    getFolder () {
      this.accountfrom.typeId = 6
