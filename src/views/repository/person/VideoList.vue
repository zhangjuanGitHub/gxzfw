    ...
    <div class="nav-head">
      <div class="breadcrumb-box">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>个人图像资料库</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
    </div>
    <el-row :gutter="10">
      ...
      <el-col :xs="21"
        ...
        <div class="AssessHead">
          <div class="tabs-card">
            <div class="card-name">
              <router-link :to="{name:'personImage'}">
            ...
            <div class="card-name">
              <router-link :to="{name:'personVideo'}">
          ...
          <template>
            <videobox v-loading="loading"></videobox>
          </template>
        </div>
      </el-col>
    </el-row>
...
import Videobox from '../components/PersonVideobox'
import { mapState, mapGetters } from 'vuex'
export default {
  name: 'Issue',
  data () {
    return {
      activeName: 'personVideo'
    }
  },
  methods: {
    handleClick (item) {
