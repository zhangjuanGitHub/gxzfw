    ...
    <el-row :gutter="10">
      ...
      <el-col :xs="21"
        ...
        <div class="AssessHead">
          <div class="tabs-card">
            <div class="card-name">
              <router-link :to="{name:'publicImage'}">
            ...
            <div class="card-name">
              <router-link :to="{name:'publicVideo'}">
...
import Picturebox from '@/views/repository/components/PublicPicturebox'
import { mapState, mapGetters } from 'vuex'
export default {
  name: 'Issue',
  data () {
    return {
      activeName: 'publicImage'
    }
  },
  methods: {
    handleClick (item) {
