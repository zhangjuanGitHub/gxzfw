  ...
  <div class="content-box new-media">
    ...
    <div class="text-center"
      ...
      <img :src="require('@/assets/images/empty-data.png')"
           alt="">
      <p class="text-click" @click="$router.push({ name: 'NewMediaWb' })">暂无数据，请前往添加</p>
    </div>
...
export default {
  ...
  methods: {
    ...
    // 编辑
    editList (item, index) {
      let toEdit = this.$router.resolve({ name: 'Contribute', query: { id: item.id, isArchive: '6', article: 'wb' } })
